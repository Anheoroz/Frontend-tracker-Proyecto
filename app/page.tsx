...
export default function Home() {
 ...
 useEffect(() => {
  const checkAuth = async () => {
    const res = await fetch("https://backend-tracker-proyecto.onrender.com/api/habits", {
      credentials: "include",
    });
  ...
  await fetch(`https://backend-tracker-proyecto.onrender.com/api/habits/${id}/done`, {
    method: "PUT",
    credentials: "include",
  });
...
const logout = async () => {
  ...
  await fetch("https://backend-tracker-proyecto.onrender.com/api/auth/logout", {
    method: "POST",
    credentials: "include",
  });
